...
# ══════════════════════════════════════════════════════════════════════
# CORE OBJECTIVE — per Pedersen et al. (2021)
# ══════════════════════════════════════════════════════════════════════
...
def objective(x, r1, r2, r_free, sd1, sd2, rho, gamma, theta, esg1, esg2,
    ...
    """
    Objective from Pedersen et al. (2021):
...
with st.expander("05  —  Ethical Screening", expanded=False):
    ...
    penalty_strength = 0.05  # independent of theta — avoids circular dependency
...
st.caption(
    "This model uses an unconstrained formulation per Pedersen et al. (2021): weights need not sum to one, "
